...
public class ClienteBiblioteca  {
    public static void main(String args[]) {
        try {
            ...
            String ISBN = "1234";  // Se usa ISBN en lugar de título
            Libro libro_isbn = gestionBiblioteca.buscarLibroISBN(ISBN);
            System.out.println("Libro encontrado: " + libro_isbn.titulo + ", " + libro_isbn.autor + ", ISBN: " + libro_isbn.ISBN);
