...
* from Biblioteca.idl
* viernes 28 de marzo de 2025 19H30' CET
*/
 ...
 implements Biblioteca.GestionBibliotecaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("buscarLibroISBN", new java.lang.Integer (1));
    _methods.put ("prestarLibro", new java.lang.Integer (2));
    _methods.put ("devolverLibro", new java.lang.Integer (3));
  }
  ...
  // Busca un libro por título y devuelve los detalles del libro
       ...
       case 1:  // Biblioteca/GestionBiblioteca/buscarLibroISBN
       {
         String ISBN = in.read_string ();
         Biblioteca.Libro $result = null;
         $result = this.buscarLibroISBN (ISBN);
         out = $rh.createReply();
         Biblioteca.LibroHelper.write (out, $result);
         break;
       }
  ...
  // Presta un libro, cambiando su estado a no disponible
       case 2:  // Biblioteca/GestionBiblioteca/prestarLibro
       {
         String ISBN = in.read_string ();
  ...
  // Devuelve un libro, cambiando su estado a disponible
       case 3:  // Biblioteca/GestionBiblioteca/devolverLibro
       {
         String ISBN = in.read_string ();
         boolean $result = false;
