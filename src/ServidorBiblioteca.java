...
class GestionBibliotecaImpl extends GestionBibliotecaPOA  {
    ...
    public GestionBibliotecaImpl(ORB orb) {
        ...
        libros.put("1234", new Libro("Peruano", "Antoine de Saint-Exupéry", "1234", true));
        libros.put("1233", new Libro("El principito", "Antoine de Saint-Exupéry", "1233", true));
    ...
    public Libro buscarLibroISBN(String ISBN) {
        ...
        return libros.getOrDefault(ISBN, new Libro("No encontrado", "", "", false));
    }
}
